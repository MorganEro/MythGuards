  ...
  return (
    <div className="contractPage">
      <div className="contract">
        <h4>
          This Contract Binds {contract?.userProfile?.displayName} with{" "}
          {contract?.guardProfile?.displayName} for the period agreed upon.
        </h4>

        <div className="contract_terms">
          <div className="contract_terms_term">Terms of Agreement:</div>
        ...
        <div className="contract_span">
          <span className="contract_span_items">
            Start Of Service :{" "}
            {new Date(contract.requestedStartingDate).toDateString()}{" "}
          </span>
          <span className="contract_span_items">
            Service Type : {contract?.serviceType?.type}{" "}
          </span>
          <span className="contract_span_items">
            End Of Service :{" "}
        ...
        <button
          ...
          className="contract_back_button"
        ...
        <button
          ...
          className="contract_edit_button"
          onClick={toggle}
        >
          Edit
        </button>
